...
# On GitHub Actions both are built; locally default to "rpm".
INSTALLER_TYPE=rpm
...
detected_modules=`$JAVA_HOME/bin/jdeps \
  ...
  --ignore-missing-deps \
  --print-module-deps \
  --module-path "${JAVAFX_BASE}/javafx-base-21.0.2-linux.jar:${JAVAFX_BASE}/javafx-controls-21.0.2-linux.jar:${JAVAFX_BASE}/javafx-fxml-21.0.2-linux.jar:${JAVAFX_BASE}/javafx-graphics-21.0.2-linux.jar" \
